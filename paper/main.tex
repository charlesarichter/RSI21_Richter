...
\end{subfigure}
\caption{\subref{fig:apparatus} Schematic diagram of the experimental apparatus
  showing three kinematic variables of the wing motion: stroke ($\phi$),
  deflection ($\psi$) and deviation ($\theta$). \subref{fig:pareto_mae} Pareto
  plot of all data-driven (``EQ Models'') and analytical models using mean
  values for model coefficients. All data-driven models were smaller and more
