...
\caption{Comparison of force predictions between $EQ_4$ (blue) and
  ...
  data shown in~\subref{fig:eq_goodbad_1}, whereas equation~\eqref{eq:badeq} was
  trained \emph{only} on the data shown in~\subref{fig:eq_goodbad_1}. Test
  experiments \subref{fig:eq_goodbad_2}, \subref{fig:eq_goodbad_3} and
  \subref{fig:eq_goodbad_4}, not contained in either model's training set, show
...
% TODO: Make correspondence more explicit. For example, mass M is a direct
% stand-in for wingspan R with a coefficient.
