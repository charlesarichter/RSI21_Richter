...
\hline
\(V^2\) Planar 1 & \(L_{planar},  F_{inertial\:(pendulum\:only)}\) & 32 & 1.38\e{-3} & 1.47\e{-3}\\
\(V^2\) Planar 2 & \(L_{planar}, F_{inertial}\) & 46 & 1.18\e{-3} & 1.29\e{-3}\\
\(V^2\) Total & \(L_{trans}, F_{inertial}\) & 96 & 1.18\e{-3} & 1.29\e{-3}\\
