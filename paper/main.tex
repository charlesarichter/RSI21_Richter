...
load cell apparatus. \hl{Mention empirically measuring impulse response.}
...
measured data\cite{richter2012thesis}. \hl{Mention polynomial fitting then
differentiation to get derivatives}.
