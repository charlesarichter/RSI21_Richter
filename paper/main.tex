...
% TODO: Figure out why we're calling it "U-squared".
\begin{table}[ht]
\small
\centering
\begin{tabular}{|l|l|r|r|r|}
\hline
  {\bf Model} & {\bf Terms/Formula} & {\bf Size} & {\bf Fitted MAE (N)} & {\bf MAE (N)}\\
\hline
...
\hline
\(U^2\) Planar 1 & \(L_{planar},  F_{inertial\:(pendulum\:only)}\) & 32 & 1.38\e{-3} & 1.47\e{-3}\\
\(U^2\) Planar 2 & \(L_{planar}, F_{inertial}\) & 46 & 1.18\e{-3} & 1.29\e{-3}\\
\(U^2\) Total & \(L_{trans}, F_{inertial}\) & 96 & 1.18\e{-3} & 1.29\e{-3}\\
WW~\cite{whitney2010aeromechanics} & \(L_{trans}, AM_{trans}, AM_{rot}\) & 121 & 1.02\e{-3} & 1.23\e{-3}\\
PW~\cite{pesavento2004falling} & \(L_{trans}, L_{rot}, AM_{trans}, AM_{trans-rot}\) & 130 & 1.01\e{-3} & 1.20\e{-3}\\
\hline
\end{tabular}
