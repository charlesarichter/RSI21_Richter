function output = fn_eq1(coeffs,eqdata)
%% Unpack Data
force = eqdata(:,1);
...
output = C1.*span.*Ycm.*defdot.*defdot.*cos(def)...
    ...
    - C3.*strokedot.*span.*def.*devddot...
    - C4.*strokedot.*span.*def.*defdot...
    - C5.*span.*devddot;

% Coeffs = [1.5723863e-8 1.2146853e-7 1.2146853e-7 1.2146853e-7 7.0700918e-7]
